...
<html lang="es">
    ...
    <body>
        ...
        <div class="table-responsive">
            ...
            <table id="tPartesDelEq" class="tabla_datos" style="width: 100%!important;max-width: 1250.4px;">
                <thead>
                    <tr>
                ...
                <tbody>
                    ...
                    <td align='center' scope='row'> 
                        ...
                        return false;' title='Editar Registro' ><i class="far fa-pencil text-warning"></i></a>
                        <?php } ?>
                    </td>
                    ...
                    <td align='center' scope='row'> 
                        ...
                        return false;'><i class="fal fa-trash text-danger"></i></a>
                        <?php } ?>
                    </td> 
                        <?php
                        echo "</tr>";
