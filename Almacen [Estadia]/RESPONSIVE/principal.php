...
<!-- JS -->
  ...
  <!-- <script src="resources/js/jquery/jquery.multiple.select.js"></script>

  <link href="resources/js/jquery/multiple-select.css" rel="stylesheet" type="text/css"> -->
...
<nav class="navbar navbar-expand-xl bg-dark navbar-dark sticky-top" style="z-index: 1;">

    <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#collapsibleNavbar" style="margin-right:10px;">
      ...
      <ul class="navbar-nav">
        ...
        while ($rs = mysql_fetch_array($opciones)) {
            ...
            if ($menuActual != $rs['menu']) {
                ...
                echo "<li class='nav-item dropdown'><a class='nav-link dropdown-toggle' href='#' data-toggle='dropdown' id='navbardrop'>
                        
                        <b id='menus'>" . ($rs['menu']) . "</b>
            ...
            if ($rs['referencia'] != "#") {
                ...
                echo "<a class='dropdown-item' href='#' onclick='cambiarContenidos(\"" . $rs['referencia'] . "\",\"".$rs['menu']." > " . $rs['submenu'] . "\"); return false;' title='".$rs['referencia']."'>" . $rs['submenu'] . "</a>";

                // echo "<a class='dropdown-item' href='#' onclick='cambiarContenidos(\"" . $rs['referencia'] . "\",\"".$rs['menu']." > " . $rs['submenu'] . "\"); return false;'>" . $rs['submenu']." - ".$rs['referencia'] . "</a>";
...
<div class="p-0 container-fluid" style=" margin-bottom: 3.9375rem" >   
  ...
  <div id="contenidos" style="position: relative; width: 100%; height:110%; margin: 0; margin-top: 35px; display: block;"><div style="height:380px"></div></div> 
...
?>
      console.log($('.ui-multiselect').parent());
