        ...
        <div class="principal">
            <div class="form-row">
                ...
                <div class="form-group col-md-4">
                    ...
                    <select id="tipoComponente" name="tipoComponente" class="custom-select">
                ...
                <div class="form-group col-md-4">
                    ...
                    <select id="almacen" name="almacen[]" multiple class="custom-select">
                ...
                <div class="form-group col-md-4">
                    <label for="EntradaSalida">Entrada/Salida</label>
                    <select id="EntradaSalida" name="EntradaSalida" class="custom-select">
                                <?php
                                if($enSa == 3){
            ...
            <div class="form-row">
                <div class="form-group col-md-3">
                    ...
                    <input type="text" class="form-control fecha_periodo" id="mes" name="mes" value="<?php echo $mes; ?>"/>
                </div>
                <div class="form-group col-md-3 p-4">
                    <input type="button" id="mostrar" name="mostrar" class="btn btn-success btn-block" value="Mostrar"/>
                </div>
            </div>
