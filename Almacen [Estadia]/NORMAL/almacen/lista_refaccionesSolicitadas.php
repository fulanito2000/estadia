            ...
            <table style="width: 100%;">
                ...
                <tr>
                    <td><input type="Button" id="boton_aceptar" name="boton_aceptar" value="Buscar ticket" class="boton" 
                               onclick="BuscarTicket('<?php echo $paginaActual; ?>');"/></td>
                    <td>
                        <?php if(isset($_GET['regresar']) && $_GET['regresar'] != ""){?>
                        <input type="button" class="boton" value="Regresar" onclick="cambiarContenidos('<?php echo $_GET['regresar']?>','')">
                        <?php }?>
                    </td>
                    <td></td>
                    <td></td>
            ...
            <?php if ((isset($_POST['mostrar']) && $_POST['mostrar'] == "true") || (isset($_GET['mostrar']) && $_GET['mostrar'] == "true")) { 
                    if(!isset($_GET['erefaccion']))
                    {
                        ...
                        if(!isset($_GET['srefaccion'])){
                            echo "<h1>Refacciones solicitadas</h1>";
                        }
                if ($permisos_grid->getModificar()) {
                    ?>
                    <input type="button" class="boton" id="guardar_seleccionados" value="Guardar seleccionados" onclick="guardarMultiplesSeleccionadas('<?php echo $paginaActual; ?>');
