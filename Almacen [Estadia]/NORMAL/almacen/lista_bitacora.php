...
<html lang="es">
    ...
    <body>
        <div class="principal">
            <br/><br/><br/>
            <form action="reportes/ReporteBitacora.php" method="post" target="_blank" id="FormularioExportacion">
                <table style="min-width: 100%;">
                    <tr>
                        <td><label for="no_serie">No. de serie</label></td>
                        <td><input type="text" id="no_serie" name="no_serie" value="<?php echo $serie; ?>"/></td>
                        <td><label for="modelo">Modelo</label></td>
                        <td><input type="text" id="modelo" name="modelo" value="<?php echo $modelo; ?>"/></td>                                                           
                        <td>
                            <?php
                            echo '<select id="cliente" name="cliente" width="100" style="width: 100px" >';
                    ...
                    <tr>
                        <td><label for="id_solicitud">No. de solicitud</label></td>
                        <td>
                            <input type="text" id="id_solicitud" name="id_solicitud" value="<?php echo $solicitud; ?>"/>
                            <div id="error_solicitud" style="color: red; display: none;">Ingresa un n&uacute;mero por favor</div>
                        </td>                    
                        <td><label for="id_bitacora">Folio de bit&aacute;cora</label></td>
                        <td>
                            <input type="text" id="id_bitacora" name="id_bitacora" value="<?php echo $bitacora; ?>"/>
                            <div id="error_bitacora" style="color: red; display: none;">Ingresa un n&uacute;mero por favor</div>
                        </td>                    
                        <td><input type="checkbox" id="mostrar_contadores" name="mostrar_contadores" <?php echo $mostrarContador; ?>/>Mostrar contadores</td>                    
                        <td><input type="button" class="button" value="Mostrar bitácoras" id="aceptar_bitacora" name="aceptar_bitacora"
                                   onclick="cargarBitacora('almacen/lista_bitacora.php','no_serie','modelo','id_solicitud','id_bitacora','cliente','mostrar_contadores'); return false;"/></td>
            ...
            <table id="tAlmacen" class="tabla_datos">
                ...
                <tbody>
                    ...
                    while ($rs = mysql_fetch_array($query)) {
                        ...
                        <td align='center' scope='row'>                        
                            <a href='#' onclick='editarRegistro("<?php echo $reporte; ?>", "<?php echo $rs[$columnas[count($columnas) - 1]]; ?>");return false;' title='Ver Reporte' >
                                <img src="resources/images/icono_impresora.png" style="width: 24px; height: 24px;"/>
                            </a>
                        </td>
                    <?php
                        echo "</tr>";
