        ...
        <div class="principal">            
            ...
            <table style="width: 100%;">
                <tr>
                    ...
                    <td>
                        <div>
                            <input type="text" id="busqueda_ticket" name="busqueda_ticket"  style="width:200px" value="<?php echo $idTicket ?>"/>                           
                        </div>
                    ...
                    <td></td>
                    <td><input type="checkbox" name="verCerrado" id="verCerrado" <?php echo $cerrados ?> value="0"/>Ver cerrados</td>
                </tr>
                <tr>                    
                    <td>Cliente</td>
                    <td>
                        <select id="cliente_ticket" name="cliente_ticket" style="width: 200px;" onchange="LocalidadesCliente(this.value);" class="filtro">
                            <?php                            
                    ...
                    <td></td>
                    <td><input type="checkbox" name="verCancelado" id="verCancelado" <?php echo $cancelados ?> value="0"/>Ver cancelados</td>
                </tr>
                <tr>
                    <td><input type="checkbox" name="ultimo_cambio" id="ultimo_cambio" <?php echo $ultimo_cambio; ?>/>Ver último cambio tóner</td>
                    <td></td>
                    <td colspan="5"></td>
                ...
                <tr>
                    <td><input type="Button" id="boton_aceptar" name="boton_aceptar" value="Buscar ticket" class="boton" 
                               onclick="BuscarTicketSolicitud('<?php echo $paginaActual; ?>');"/></td>
                    <td>
                    ...
                    <td></td>
                    <td></td>
                    <td><input type="checkbox" name="verMoroso" id="verMoroso" <?php echo $moroso ?> value="1"/>Ver Morosos</td>
                </tr>                              
            </table>
            ...
            <?php if( (isset($_POST['mostrar']) && $_POST['mostrar']=="true") || $idTicket != ""){ 
                    if(!isset($_GET['etoner']))
                    {
                        ...
                        if(!isset($_GET['stoner'])){
                            echo "<h1>T&oacute;ner solicitado</h1>";
                        }
                if($permisos_grid->getModificar()){ ?>
                <br/><br/>
                <?php if(!isset($_GET['stoner'])){ ?>
                <input type="button" style=" margin-left: 90%" class="boton" value="Antender y Enviar"  onclick="atenderNotaTonerSolicitado('almacen/toner_solicitado.php', '1');" />
                <?php  } ?>
                <input type="Button" id="boton_atender" name="boton_atender" value="Atender" class="boton"             
                    onclick="atenderNotaTonerSolicitado('<?php echo $paginaActual; ?>','0');" style="margin-left: 86%;"/><br/>
            <?php } 
            ...
            <?php   }
                    if(!isset($_GET['stoner'])){   
                        echo "<br/><br/>";
                        if(!isset($_GET['etoner'])){
                            echo "<h1>Env&iacute;o de t&oacute;ner</h1>";
                        }
                    if($permisos_grid->getModificar()){ 
                        $varAux = "null";
                        if(isset($_GET['etoner'])){
            ...
            <input type="button" id="enviar" name="enviar" onclick="envioMultiple('<?php echo $varAux; ?>'); return false;" class="boton" style="margin-left: 86%;" value="Enviar"/>
            <?php } ?>
            <br/>
            ...
            <input type="button" id="enviar" name="enviar" onclick="envioMultiple('<?php echo $varAux; ?>'); return false;" class="boton" style="margin-left: 92%;" value="Enviar"/>
            <?php   } 
                    }
                } 
            ?>         
