        ...
        <div class="principal">            
            ...
            <table>
                <tr>
                    <td>Serie</td>
                    <td>
                        <input type="text" id="NoSerieConfi" name="NoSerieConfi" value="<?php echo $NoSerie; ?>"/>
                    </td>
                    <td>Modelo</td>
                    <td>
                        <input type="text" id="ModeloConfi" name="ModeloConfi" value="<?php echo $Modelo; ?>"/>
                    </td>
                    <td>
                        <input type="button" id="ver_equiposConfi" name="ver_equiposConfi" value="Mostrar equipos" class="button" 
                               onclick="mostrarEquiposConfiguracion('<?php echo $same_page; ?>','NoSerieConfi','ModeloConfi')"/>
                    </td>
                </tr>
            </table>
            <br/>
