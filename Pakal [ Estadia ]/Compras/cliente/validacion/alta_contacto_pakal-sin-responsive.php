    ...
    <body>        
        <fieldset>
            ...
            <form id="formContacto" name="formContacto" action="/" method="POST">
                    ...
                    <tr>
                        ...
                        <td>
                            <select id="tipo_contacto2" name="tipo_contacto2" style="width: 250px;">
                                <?php/*
                                $query = $catalogo->getChofer("c_tipocontacto", "Nombre");
                ...
                <?php if($cliente){ ?>
                <input type="submit" id="cancelar_contacto" class="boton" value="Cancelar" style="float: right; margin-right: 5px;" onclick='cambiarContenidosContacto("../compras/crearCamion.php?idTicket=<?php echo $idTicket; ?>");return false;'/>
                <?php }else{?>
                <input type="submit" id="cancelar_contacto" class="boton" value="Cancelar" style="float: right; margin-right: 5px;" onclick="cambiarContenidoValidaciones('contacto2', '../compras/crearCamion.php',  <?php  if(isset($_POST['idTicket'])){ echo "'".$_POST['idTicket']."'";} else{ echo "null"; } ?>, '<?php echo $_GET['id']; ?>', null);return false;"/>
                <?php }
