...
$dia = date('d');
$fecha = $anio . "-" . $mes . "-" . $dia;
$pagina_listaRegresar = "mesa/lista_ticket_pakal.php";
            ...
            */?>
            ...
            <fieldset>
                ...
                <form id="formAgregarNota" name="formAgregarNota" action="/" method="POST" enctype="multipart/form-data">
                    ...
                    ?>
                    <div class="row">
                        <div class="col-lg-6 offset-lg-3 col-md-6 col-sm-12" style="display: flex;flex-direction: column;">
                            <label for="fecha">Fecha: </label>
                            <input type='text' id='fecha' name='fecha' value="<?php echo $fecha ?>"/>
                            <label for="diagnostico">Diagnóstico o solución al reporte:</label>
                            <textarea id='diagnostico' name='diagnostico' cols='50'><?php echo $diagnostico; ?></textarea>
                            <label for="estatus">Estatus de atención:</label>
                            ...
                            <label for="file">Subir archivo para incidencias:</label>
                        ...
                        <div class="col-lg-6 offset-lg-3 col-md-6 col-sm-12" style="display: flex;flex-direction: column;">
                            ...
                            <label for="show">Mostrar a cliente</label>
                            <input type="checkbox" name="show" id="show" <?php echo $show; ?>/>
                        </div>
                    </div>
                    ...
                    <div id="refacciones" name="refacciones" style="display:none;">   
                        ...
                        <table id="nuevaRefaccion" style="width:70%">
                    ...
                    <?php if ($areaTickte == "") { ?>
                        <div align="center">
                        <input type="submit" class="btn btn-danger" value="Cancelar" onclick="cambiarContenidos('<?php echo $pagina_listaRegresar; ?>');
                                    return false;"/>
                        </div>
                           <?php } else { ?>
                        <input type="submit" class="btn btn-danger" value="Cancelar" onclick="cancelarNota('<?php echo $pagina_lista; ?>', '<?php echo $idTicket; ?>', '<?php echo $areaTickte; ?>');
                                    return false;"/>
                           <?php } ?>
